...
const InputField = ({
  ...
  return (
    <div className={`w-full flex flex-col justify-center items-end my-2 ${customStyleComponent}`}>
      {headerText && (
      ...
      {error && <p className='text-sm text-red-500 mt-1 rounded-lg bg-slate-100 px-1'>{error}</p>}
    </div>
  );
};
