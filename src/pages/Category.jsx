    ...
    <div className="bg-gradient-to-t from-[#33663b] to-[#55B063] min-h-[100vh] flex flex-col items-center">
      <div className="w-full flex flex-col justify-center items-center relative">
        ...
        <p className="text-slate-50 text-sm w-full px-8 md:px-16 my-2 md:my-4 md:text-lg text-right">
          {" "}
          يمكن لكادر العمل إضافة المقالات التوعوية لتظهر في
          التطبيق لدى المستخدمين
        </p>
      </div>
      <Link to={`/green_syria/dashboard/categories/${categoryid}/addArticle`} className="my-2 md:my-5 bg-slate-50 w-[80%] text-center rounded-lg p-2 md:p-4 text-sm md:text-lg text-green-600 hover:bg-yellow-50">
        إضافة مقال جديد 
      </Link>
