...
const AddAdmin = () => {
  ...
  const value = 4;
  return (
    <div className="bg-gradient-to-t from-[#33663b] to-[#55B063] min-h-[100vh] w-full flex flex-col py-8">
      <div
        className={`w-full flex flex-col md:flex-row-reverse md:justify-center items-center pb-8`}
      >
      ...
      <div className="w-full flex justify-center flex-col items-center">
        <p className="text-white fontReg text-lg md:text-2xl my-10">
          حسابات الآدمن
        </p>
        <div
